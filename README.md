RoadLens: Real-Time Traffic Sign Recognition
...
Convolutional Layers: Extract spatial features from 32x32 images.
Max Pooling: Reduces dimensionality while retaining important features.
Dropout Layers: Prevent overfitting (set at 0.5).
...
Mapping predictions to readable labels (e.g., "Speed Limit 50 km/h")
🛠️ Tech Stack
Languages: Python
...
Contributions, issues, and feature requests are welcome! Feel free to fork the repo and improve the system.

👨‍💻 Author

Developed by Kunal Singh
B.Tech Computer Science (AI/ML) @ RV University